    ...
    <table  style="font-size:14px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr style="line-height: 30px; height: 30px">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:130px">{{$datatitle[8]}}</td>
    		...
    		@endforeach
    		<tr style="line-height: 30px; height: 30px"><td colspan="10" style="border-top: 1px solid #000;border-left:1px solid #000;border-right:1px solid #000;">{{$tabletitle[6]}}{{$total}}</td></tr>
    		<tr style="line-height: 30px; height: 30px">
