  ...
  <div class="panel-body" id="table">
    <table  style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr><td colspan="4">{{$tabletitle[3]}}</td><td colspan="3">{{$tabletitle[4]}}</td><td colspan="3">{{$tabletitle[5]}}</td></tr>
    		<tr>
    		...
    		@endforeach
    		<tr><td colspan="10" style="border-top: 1px solid #000;border-left:1px solid #000;border-right:1px solid #000;">{{$tabletitle[6]}}{{$total}}</td></tr>
    		<tr>
