  ...
  <div class="panel-body" id="table">
    <table  style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
			...
			<tr style="line-height: 30px; height: 30px"><td style="border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" colspan="11" align="center">赠品信息</td></tr>
			<tr style="line-height: 30px; height: 30px">
