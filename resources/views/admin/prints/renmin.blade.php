    ...
    <table  style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:30px">{{$datatitle[6]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:30px">{{$datatitle[7]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px">{{$datatitle[8]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px">{{$datatitle[9]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:300px">{{$datatitle[10]}}</td>
    		...
    		<tr>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000">中国</td>   			
    		</tr>
    		@endforeach
    		<tr><td style="border-bottom:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" colspan="12" >{{$tabletitle[4]}}{{$total}}</td></tr>
    	</tbody>
    </table>
  </div>
