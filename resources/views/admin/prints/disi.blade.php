    ...
    <table  style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr style="line-height: 30px; height: 30px">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px" align="center">{{$datatitle[3]}}</td>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:30px" align="center">{{$datatitle[11]}}</td>
    		</tr>
    		...
    		@endforeach
    		<tr style="line-height: 30px; height: 30px"><td style="border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" colspan="12" >{{$tabletitle[4]}}{{$total}}</td></tr>
