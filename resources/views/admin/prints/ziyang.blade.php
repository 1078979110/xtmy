	  ...
	  <div class="horizontal" id="table">
		  <table  style="font-size:10px;word-break:break-all; word-wrap:break-word; word-break-wrap: all" cellpadding="0" cellspacing="0">
				...
				<tr style="height: 15px;line-height: 15px">
					<td style="border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000; width:180px" align="center">{{$datatitle[0]}}</td>
					...
					<td style="border-right:1px solid #000;border-top:1px solid #000; width:150px" align="center">{{$datatitle[13]}}</td>
				</tr>
				</thead>
			  <tbody>
