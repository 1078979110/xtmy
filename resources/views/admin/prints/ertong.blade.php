  ...
  <div class="panel-body" >
    ...
    <table width="680" style="font-size:10px; word-break:break-all; word-wrap:break-word;" cellpadding="0" cellspacing="0">
    		...
    		<tr style="line-height: 15px; height: 15px">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:59px" align="center">{{$datatitle[1]}}</td>
		...
		<tbody>
    		...
    		<tr style="line-height: 15px; height: 15px">
    			<td style="word-break:break-all; word-wrap:break-word;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000; width:130px" align="center">{{$list['medicinal']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:59px" align="center">{{$list['medicinalnum']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['unit']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['batchnumber']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['invalidate']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['price']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['num']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['prices']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:130px" align="center">{{$list['manufactur']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$list['novirus']}}</td>
