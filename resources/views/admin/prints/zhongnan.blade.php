  ...
  <div class="panel-body" id="table">
    <table  style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr><td colspan="5">{{$tabletitle[1]}}</td><td colspan="5" align="right">{{$tabletitle[2]}}</td></tr>
    		<tr><td colspan="3">{{$tabletitle[3]}}</td><td colspan="2">{{$tabletitle[4]}}</td><td colspan="2">{{$tabletitle[5]}}</td><td colspan="3" align="right">{{$tabletitle[6]}}</td></tr>
    		<tr>
