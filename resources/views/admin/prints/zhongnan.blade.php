  ...
  <div class="panel-body" >
    ...
    <table width="680" style="font-size:10px;word-break:break-all; word-wrap:break-word; width: 680px" cellpadding="0" cellspacing="0">
    		...
    		<tr style="line-height: 15px; height: 15px; padding: 0">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:60px" align="center">{{$datatitle[3]}}</td>
		...
		<tbody>
    		...
    		<tr style="line-height: 15px; height: 15px">
    			<td style="word-break:break-all; word-wrap:break-word;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" width="150" align="center">{{$list['medicinal']}}</td>
    			...
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="60" align="center">{{$list['num']}}</td>
    			...
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="600" align="center">{{$list['prices']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="80" align="center">{{$list['makedate']}}</td>
...
function print_view(temp){
	...
	LODOP.ADD_PRINT_TABLE(10,48,"RightMargin:0.3cm",'100%',document.getElementById(temp).innerHTML);
	LODOP.PREVIEW();
}
function print(temp){
    LODOP=getLodop();
