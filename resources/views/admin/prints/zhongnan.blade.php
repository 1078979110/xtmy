  ...
  <div class="panel-body" id="table">
    <table  style="font-size:14px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr style="line-height: 30px; height: 30px"><td colspan="3">{{$tabletitle[3]}}</td><td colspan="2">{{$tabletitle[4]}}</td><td colspan="2">{{$tabletitle[5]}}</td><td colspan="3" align="right">{{$tabletitle[6]}}</td></tr>
