  ...
  <div class="panel-body"  >
    ...
    <table width="680" style="font-size:10px;word-break:break-all; word-wrap:break-word;width: 680px" cellpadding="0" cellspacing="0">
    		...
    		<tr style="line-height: 15px; height: 15px; padding: 0">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:130px" align="center">{{$datatitle[2]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:50px" align="center">{{$datatitle[3]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:30px" align="center">{{$datatitle[4]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:130px" align="center">{{$datatitle[5]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:30px" align="center">{{$datatitle[6]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:20px" align="center">{{$datatitle[7]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:20px" align="center">{{$datatitle[8]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:40px" align="center">{{$datatitle[9]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:40px" align="center">{{$datatitle[10]}}</td>
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:67px" align="center">{{$datatitle[11]}}</td>
		...
		<tbody>
    		...
    		<tr style="line-height: 15px; height: 15px; padding: 0">
    			...
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="20" align="center">{{$list['unit']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="20" align="center">{{$list['price']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="40" align="center">{{$list['batchnumber']}}</td>
    			...
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="67" align="center">{{$list['registnum']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="50" align="center">{{date('Y-m-d', strtotime($list['registivalidate']))}}</td>
    		</tr>
    		@endforeach
		</tbody>
		<tfoot>
	  ...
	  <div class="horizontal" style="margin-top: 10px">
		  <div class="form-group" id="template_forfinance" style="margin:0; padding:0">
			  <table style="font-size:14px;" cellpadding="0" cellspacing="0">
				  ...
				  <tr style="line-height: 30px; height: 30px"><td colspan="10"><span class="pull-left">{{$tabletitle[1]}}</span><span class="pull-left"><input type="text" class="form-control orderid" style="width: 150px" value="{{$orderinfo->orderid}}"></span></td></tr>
				  <tr style="line-height: 30px; height: 30px">
