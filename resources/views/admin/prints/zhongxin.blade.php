<div class="panel panel-default">
  ...
  <div class="panel-body" id="table" >
    <table style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
    		<tr><td colspan="11" align="center" style="font-size: 14px; font-weight:bold">{{$tabletitle[0]}}</td></tr>
    		<tr><td colspan="6">{{$tabletitle[1]}}</td><td colspan="5">{{$tabletitle[2]}}</td></tr>
    		<tr><td colspan="4">{{$tabletitle[3]}}</td><td colspan="2">{{$tabletitle[4]}}</td><td colspan="2">{{$tabletitle[5]}}</td><td colspan="3">{{$tabletitle[6]}}</td></tr>
    		<tr>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px">{{$datatitle[2]}}</td>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px">{{$datatitle[7]}}</td>
    		...
    		@endforeach
    		<tr><td style="border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" colspan="12" >{{$tabletitle[7]}}{{$total}}</td></tr>
    		<tr>
