  ...
  <div class="panel-body"  >
    ...
    <table width="680" style="font-size:10px;word-break:break-all; word-wrap:break-word; width: 680px" cellpadding="0" cellspacing="0">
    		...
    		<tr style="line-height: 15px; height: 15px">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width: 40px" align="center">{{$datatitle[4]}}</td>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width: 49px" align="center">{{$datatitle[10]}}</td>
    		</tr>
			</thead>
		<tbody>
    		...
    		<tr style="line-height: 20px; height: 20px">
    			...
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="50" align="center">{{$list['makedate']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="50" align="center">{{$list['batchnumber']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="70" align="center">{{$list['registnum']}}</td>
    			<td style="word-break:break-all; word-wrap:break-word;border-right:1px solid #000;border-top:1px solid #000" width="49" align="center">{{$list['invalidate']}}</td>
    		</tr>
    		@endforeach
		</tbody>
		<tfoot>
