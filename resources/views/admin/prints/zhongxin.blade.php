  ...
  <div class="panel-body" id="table" >
    <table style="font-size:12px" cellpadding="0" cellspacing="0">
    	<tbody>
    		...
    		<tr style="line-height: 30px; height: 30px"><td colspan="4">{{$tabletitle[3]}}</td><td colspan="2">{{$tabletitle[4]}}</td><td colspan="2">{{$tabletitle[5]}}</td><td colspan="3">{{$tabletitle[6]}}</td></tr>
    		<tr style="line-height: 30px; height: 30px">
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px" align="center">{{$datatitle[2]}}</td>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:80px" align="center">{{$datatitle[7]}}</td>
    			...
    			<td style="border-right:1px solid #000;border-top:1px solid #000; width:100px" align="center">{{$datatitle[10]}}</td>
    		</tr>
    		...
    		@endforeach
    		<tr style="line-height: 30px; height: 30px"><td style="border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" colspan="12" >{{$tabletitle[7]}}{{$total}}</td></tr>
			<tr style="line-height: 30px; height: 30px"><td style="border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000" colspan="12" align="center">赠品信息</td></tr>
			<tr style="line-height: 30px; height: 30px">
