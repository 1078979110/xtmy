<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="/admin/api/updateattr" method="post">
            ...
            <div class="form-group">
                <table class="table">
                    <thead><tr><th>名称</th><th>产品货号</th><th>单位</th><th>数量</th><th>价格</th><th>批号</th><th>灭菌批号</th><th>生产日期</th><th>失效日期</th><th>装箱规格</th><th>原产地</th><th>备注/说明</th></tr></thead>
                    <tbody>
                    @foreach($products as $key => $product)
                        <tr>
                            ...
                            <td><input type="text" name="info[{{$product->id}}][originmake]" value="{{$product->originmake}}" class="form-control"></td>
                            <td><input type="text" name="info[{{$product->id}}][tips]" value="{{$product->tips}}" class="form-control"></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
